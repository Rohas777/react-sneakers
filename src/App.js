          ...
          <div className="container">
            <div className="catalog__content">
              <div className="catalog__header">
                ...
                <p className="catalog__search">Поиск...</p>
              </div>
              <div className="catalog__cards">
                <div className="card">
                  <div className="card__wrapper">
                    <button className="card__fav">
                      <img width={14.4} height={12.8} src="/img/addToFavs.svg" alt="favorite" />
                    </button>
                    <img width={133} height={112} src="/img/sneakers/01.jpg" alt="sneakers" className="card__image"/>
                    ...
                    <div className="card__bottom">
                      ...
                      <button className="card__add">
                        <img width={11} height={11} src="/img/addToCart.svg" alt="add" />
                      </button>
                    </div>
                  </div>
                </div>
                <div className="card">
                  <div className="card__wrapper">
                    ...
                    <img width={133} height={112} src="/img/sneakers/02.jpg" alt="sneakers" className="card__image"/>
                    <p className="card__desc">Мужские Кроссовки Nike Blazer Mid Suede</p>
                    <div className="card__bottom">
                      <div className="card__price">
                        <p>Цена:</p>
                ...
                <div className="card">
                  <div className="card__wrapper">
                    ...
                    <img width={133} height={112} src="/img/sneakers/03.jpg" alt="sneakers" className="card__image"/>
                    <p className="card__desc">Мужские Кроссовки Nike Blazer Mid Suede</p>
                    <div className="card__bottom">
                      <div className="card__price">
                        <p>Цена:</p>
